...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \newnote{Submatrices de $A$ inversibles $\Rightarrow$ tiene factorización LU}
        ...
        \item $M_k M_{k-1} \dots M_1 A = U$ 
        \item $M_1 = I - r_1e_1^t$, donde $r_1 = \begin{pmatrix}
        0 \\
        m_{21}\\
        m_{31} \\
        m_{41}
        \end{pmatrix}$ y $m_{ij} = \frac{a_{ij}}{a_{jj}}$ 
    \end{itemize}
\end{enumerate}
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \alertnote{$\hat{L}$ \textbf{no necesariamente} tiene "unos" en la diagonal, pero $l_{ii} > 0$}
    \end{itemize}
\end{enumerate}
